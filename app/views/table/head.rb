module Views
  class Table
    class Head < ApplicationComponent
      ...
      def select_cell
        th scope: "col",
          class: "w-12 min-w-12 max-w-12 relative text-center sticky top-0 left-px z-10 bg-gray-50 whitespace-nowrap px-2 py-3.5 text-sm font-semibold text-gray-900",
          id: "column_select" do
